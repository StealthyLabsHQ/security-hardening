...
|---|---|---|
| Secure code review, web auth, headers, input validation, XSS, SSRF, insecure defaults | `references/_core-invariants.md`, `references/appsec/owasp-top10.md`, `references/appsec/api-security.md`, `references/appsec/browser-security-modern.md` | `references/platform/*` unless the target is a desktop or mobile app; `references/compliance/*` unless an audit mapping is explicitly requested |
