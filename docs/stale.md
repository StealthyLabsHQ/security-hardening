...
| File | Reason |
|---|---|
| `references/compliance/compliance-mapping.md` | Cross-framework mapping needs explicit framework-version verification before claiming current review status. |
